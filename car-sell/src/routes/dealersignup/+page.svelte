...
<form on:submit|preventDefault={handlesignup} class="max-w-400 mx-auto gap-2 flex flex-col bg-gray-600 p-8 rounded-2xl mt-12">
    <h1 class="text-2xl font-bold block bg-transparent text-white text-center">Dealer SignUp</h1>
    ...
    <button type="submit" class="block p-4 text-base bg-blue-300 border border-blue-300 rounded hover:bg-purple-300 focus:bg-orange-300">SignUp</button>
</form>
<style>
