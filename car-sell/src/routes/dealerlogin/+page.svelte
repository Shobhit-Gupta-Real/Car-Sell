<script>
    ...
    const response = await fetch('http://localhost:3000/dealerlogin',{
      method:'POST',
...
<form on:submit|preventDefault={handleLogin} class="max-w-400 mx-auto gap-2 flex flex-col bg-gray-600 p-8 rounded-2xl mt-12">
<h1 class="text-2xl font-bold block bg-transparent text-white text-center">Dealer Login</h1>
...
<a href="/dealersignup" class="text-white text-center">SignUp?</a>
</form>
<style>
@tailwind base;
@tailwind components;
